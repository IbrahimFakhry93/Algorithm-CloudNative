...
//* we can use adjacency list for graph representation
...
//* so it's a burden on processor and memory

//* so it's important to understand how every data structure works in each language
...
//! we didn't use boolean array for visited vertices
//* because we use characters for vertex name not numbers as before in prim MST
//* so we can't use array's indices to place the numbered vertices (vertex number = boolean array index)
//* and also sometimes if the nodes or vertices are auto generated ID not in sequence
...
//? assign the destination vertices to destination array
