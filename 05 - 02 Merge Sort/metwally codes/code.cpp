...
void merge(int array[], int start, int mid, int end)
{
    ...
    //* To fix the error "expression must have a constant value", replace the variable-length arrays with dynamic memory allocation using new and remember to delete[] them after use.
    // int left_array[left_length]; //! expression must have a constant value
